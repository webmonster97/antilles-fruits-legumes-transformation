...
| **Type de transformation**         | **Produit obtenu**                                                                         |
| ---------------------------------- | ------------------------------------------------------------------------------------------ |
| Aliments minimalement transformés  | Feuille de gros thym                                                                       |
| Ingrédients culinaires transformés | Huile de gros thym                                                                         |
| Aliments transformés               | Assaisonnements à base de gros thym, marinades                                             |
| Produits ultra-transformés         | Compléments alimentaires à base de gros thym, extraits de gros thym, infusion de gros thym |
